...
@Then("^User enters the email id and user enters the password$")
public void user_enters_the_email_id_and_user_enters_the_password() throws Throwable {
    // Write code here that turns the phrase above into concrete actions
	  driver.findElement(By.name("username")).sendKeys("login9abc");
